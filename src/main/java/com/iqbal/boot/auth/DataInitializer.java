package com.iqbal.boot.auth;

import com.iqbal.boot.auth.domain.User;
import com.iqbal.boot.auth.domain.Vehicle;
import com.iqbal.boot.auth.repository.UserRepository;
import com.iqbal.boot.auth.repository.VehicleRepository;
